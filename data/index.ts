...
export const testimonials: TestimonialType[] = [
  {
    quote:
      "I've worked closely with Mahak for a very long time and know him well. He has a strong curiosity about technologies and excels at diving deep into concepts. He can break down problems into manageable pieces and write code accordingly. His debugging and feature-building skills are exceptional. Beyond his technical abilities, his communication skills are commendable, making him a complete package.",
    name: "Mahak Pandey",
    title: "Front-end Web Developer",
  },
  {
    quote:
      "I've worked with Mahak in one of my recent projects talking about his skills he has got a good grip over frontend technologies like react redux typescript. He can understand the business perspective and think of a solution considering business perspective",
    name: "Sachin Patel",
    title: "Sr. Fullstack developer",
  },
  {
    quote:
      "Mahak mam is really dedicated to his team. When there's a tough problem, he takes charge and works hard to solve it. He spends time finding solutions, making sure the project goes well. Personally, when I have problems, he helps me out a lot.",
    name: "Krishna Rathod",
    title: "Front end Developer",
  },
  {
    quote:
      "Mahak mam's positive attitude and willingness to collaborate make him a pleasure to work with. He approaches challenges with a can-do attitude and is always ready to lend a helping hand to his teammates.",
    name: "Aditya Pandey",
    title: "Backend developer ",
  },
];
...
export const workExperience: WorkExperienceType[] = [
  {
    id: 1,
    title: "Jr. Software engineer - Infosys",
    desc: "Assisted in the development of a web-based platform using React.js, enhancing interactivity.",
    className: "md:col-span-2",
    thumbnail: "/exp1.svg",
  },
